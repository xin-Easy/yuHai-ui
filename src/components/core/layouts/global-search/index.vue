    ...
    >
      ...
      >
        <template #suffix>
          ...
          >
            <SvgIcon icon="fluent:arrow-enter-left-20-filled" />
          </div>
        </template>
      </ElInput>
        ...
        <div class="result w-full" v-show="searchResult.length">
          ...
          >
            ...
            >
              ...
              <SvgIcon v-show="isHighlighted(index)" icon="fluent:arrow-enter-left-20-filled" />
            </div>
          </div>
        </div>
        ...
        <div v-show="!searchVal && searchResult.length === 0 && historyResult.length > 0">
          ...
          <div class="mt-1.5 w-full">
            ...
            >
              ...
              >
                <SvgIcon icon="ri:close-large-fill" class="text-xs" />
              </div>
            </div>
          </div>
        </div>
      ...
      <template #footer>
        <div class="dialog-footer box-border flex-c border-t-d pt-4.5 pb-1">
          <div class="flex-cc">
            <SvgIcon icon="fluent:arrow-enter-left-20-filled" class="keyboard" />
            <span class="mr-3.5 text-xs text-g-700">{{ $t('search.selectKeydown') }}</span>
          </div>
          <div class="flex-c">
            <SvgIcon icon="ri:arrow-up-wide-fill" class="keyboard" />
            <SvgIcon icon="ri:arrow-down-wide-fill" class="keyboard" />
